module.exports = {
	...
	langs: {
		...
		en: {
			count: "─────────────────────\n👥💬 | 𝐍𝐮𝐦𝐛𝐞𝐫 𝐨𝐟 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬 𝐨𝐟 𝐦𝐞𝐦𝐛𝐞𝐫𝐬:\n─────────────────────",
		      
			endMessage: "─────────────────────\n👥⚠️ | 𝐓𝐡𝐨𝐬𝐞 𝐰𝐡𝐨 𝐝𝐨 𝐧𝐨𝐭 𝐡𝐚𝐯𝐞 𝐚 𝐧𝐚𝐦𝐞 𝐢𝐧 𝐭𝐡𝐞 𝐥𝐢𝐬𝐭 𝐡𝐚𝐯𝐞 𝐧𝐨𝐭 𝐬𝐞𝐧𝐭 𝐚𝐧𝐲 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬.\n─────────────────────",
		      
			page: "─────────────────────\n👥📄 | 𝐏𝐚𝐠𝐞 [𝐏𝐚𝐠𝐞 %1/%2]\n─────────────────────",
		      
			reply: "─────────────────────\n👥🔄 | 𝐑𝐞𝐩𝐥𝐲 𝐭𝐨 𝐭𝐡𝐢𝐬 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐰𝐢𝐭𝐡 𝐭𝐡𝐞 𝐩𝐚𝐠𝐞 𝐧𝐮𝐦𝐛𝐞𝐫 𝐭𝐨 𝐯𝐢𝐞𝐰 𝐦𝐨𝐫𝐞\n─────────────────────",
		      
			result: "─────────────────────\n👥🏆 | %1 𝐫𝐚𝐧𝐤𝐞𝐝 %2 𝐰𝐢𝐭𝐡 %3 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬\n─────────────────────",
		      
			yourResult: "─────────────────────\n👥🎖️ | 𝐘𝐨𝐮 𝐚𝐫𝐞 𝐫𝐚𝐧𝐤𝐞𝐝 %1 𝐚𝐧𝐝 𝐡𝐚𝐯𝐞 𝐬𝐞𝐧𝐭 %2 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬 𝐢𝐧 𝐭𝐡𝐢𝐬 𝐠𝐫𝐨𝐮𝐩\n─────────────────────",
